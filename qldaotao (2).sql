...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 03, 2018 lúc 10:15 AM
...
(1, 'Chương trình Đào tạo ngành CNTT - Chính quy', 1, 1, 1, 200, 8, ''),
(2, 'Chương trình đào tạo Hệ thống Thông tin quản lý - Hệ chính quy', 1, 1, 1, 0, 7, ''),
(3, 'Chương trình Đào tạo MMT&TTDL', 2, 1, 1, 140, 8, '');
...
--
ALTER TABLE `tblchitietctdt`
  MODIFY `IDchitiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
