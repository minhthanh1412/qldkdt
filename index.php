...
<body>
    ...
    <div class ="selCTDT" style="text-align: center;">
        <form  name="frmCapNhat" id="frmCapNhat" method="POST">
            <div class="form-group">
                <a href="ThemCTDT.php" data-toggel="tooltip" title="Thêm Chương trình Đào tạo!">...</a>
                ...
                <a href="Export.php"><img src="images/excel.png" data-toggel="tooltip" title="Xuất chương trình Đào tạo Excel.." style="width: 5%; margin-left: 0px" /></a>
                
            </div> 
        </form>
        <button style="width: 100px" onclick="myFunction()" type="get"  name ="ShowTC" id ="ShowTC" class="btn btn-primary" data-toggel="tooltip" title="Nhấn để xem số Tín chỉ của chương trình">Xem TC</button>     
  ...
  <div class="row">
    <div class="col-md-5" style="background-color: #EEEEEE">
        <a href="importexcel.php"><img src="images/excel.png" data-toggel="tooltip" title="Thêm Môn học bằng file Excel.." style="width: 7%; margin-left: 0px" /></a>
        <a href="InsertSJ.php" target="_blank"><button type="button" name="add" id="add" class="btn btn-success btn-sm add" data-toggel="tooltip" title="Thêm 1 môn học mới.."><span class="glyphicon glyphicon-plus"></span></button></a>
...
<div class="col-md-6">
    <!-- Bang cac Hki -->   
    <input  align="center" readonly="" name ="save" id ="save" class="btn btn-primary" data-toggel="tooltip" title="Lưu Chương trình  Đào tạo!" value="Lưu chương trình"></input>     
    <!-- I -->
