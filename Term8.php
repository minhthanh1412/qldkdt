...
$sql = "SELECT id, tenMon, tongSoTC, soTCLyThuyet, soTCThuchanh FROM tblmonhoc, tblchitietctdt WHERE tblmonhoc.id = tblchitietctdt.maMH AND tblchitietctdt.soTTHK = 8";
